    ...
    <div className="home">
      <div className="notifications-page">
        ...
        <div className="connection-requests">
          ...
          {notifications.filter((notif) => notif.type === "follow_request")
            .length > 0 ? (
            <ul>
              {notifications
        ...
        <div className="article-notifications">
          ...
          {notifications.filter(
            (notif) => notif.type === "new_comment" || notif.type === "new_like"
          ).length > 0 ? (
            <ul>
              {notifications
                .filter(
                  (notif) =>
                    notif.type === "new_comment" || notif.type === "new_like"
                )
                .map((notification) => (
                  <li key={notification.id}>
                    <p>
                      User {notification.type_id} showed interest in your
                      article.
                    </p>
