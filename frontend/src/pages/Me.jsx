    ...
    useEffect(() => {
        const fetchDetails = async () => {
            try {
                ...
                const { experience, education, skills, experience_public, education_public, skills_public } = response.data;
        ...
        <div className='PersonalDetails-page'>
            ...
            <div className='Details-container'>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    {!editMode && (
                        <button className="change-details-button" onClick={() => setEditMode(true)}>
                            Change Details
                        </button>
                    )}
                    {/*  button to save changes */}
                    {editMode && <button className="submit-button" type="submit">Save</button>}
                </form>
            </div>
        </div>
    );
